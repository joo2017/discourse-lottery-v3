...
export default class LotteryForm extends Component {
  ...
  // 检查参与门槛是否有效
  get isMinParticipantsValid() {
    return this.minParticipants >= this.globalMinParticipants;
  }
