{{#d-modal-body 
  ...
  <div class="lottery-form">
    {{#if flashMessage}}
      <div class="alert {{if (eq flashType 'success') 'alert-success' 'alert-error'}}">
        {{flashMessage}}
      </div>
    {{/if}}

    <div class="lottery-form-description">
      <p>填写抽奖活动信息，系统将自动在主题中显示抽奖详情并在指定时间开奖。</p>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        ...
        <div class="help-text">
          最少需要多少人参与才能开奖（不能低于全局设置：{{globalMinParticipants}} 人）
        </div>
      </div>
    </div>
