...
export default class LotteryForm extends Component {
  ...
  @action updateLotteryData(field, event) { this.lotteryData[field] = event.target.value; }
  @action updateLotteryDataFromComponent(field, value) { this.lotteryData[field] = value; }
  @action validateMinParticipants(value) {
    const s = this.args.siteSettings;
    ...
    } else { this.minParticipantsError = null; }
  }
}
